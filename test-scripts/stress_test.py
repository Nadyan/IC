#
# Teste de Stress - Switch SDN
# Adaptado de https://wiki.opendaylight.org/view/OpenDaylight_OpenFlow_Plugin::Python_test_scripts
#
# Nadyan Suriel Pscheidt - Bolsista de Iniciacao Cientifica
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='End to end stress tests of flows addition from multiple connections')
    
    parser.add_argument(    '--odlhost',              default = '10.10.10.202',     help='host where odl controller is running'                    )
    parser.add_argument(    '--odlport',    type=int, default = 8181,               help='port on which odl\'s RESTCONF is listening'              )
    parser.add_argument(    '--mnport',     type=int, default = 6653,               help='port on which odl\'s controller is listening'            )
    parser.add_argument(    '--threads',              default = 50,                 help='how many threads should be used'                         )
    parser.add_argument(    '--flows',                default = 20,                 help='how many flows will add one thread'                      )
    parser.add_argument(    '--log',                  default = 'info',             help='log level, permitted values are debug/info/warning/error')
